...
MODEL_FILE="Huihui-Qwen3.5-27B-abliterated.Q4_K_M.gguf"
MODEL_PATH="${MODEL_DIR}/${MODEL_FILE}"
MODEL_URL="https://huggingface.co/mradermacher/Huihui-Qwen3.5-27B-abliterated-GGUF/resolve/main/${MODEL_FILE}"
